...
const Portfoliov2 = React.forwardRef(({ mainRef }) => {
  ...
  return (
    <div className="w-full lg:fixed h-fit mt-10 lg:mt-0 relative z-10  ">
      ...
      <div className="flex justify-between w-full h-auto ">
        <div className=" lg:visible invisible  text-zinc-200  flex items-center bg-red-50 justify-center flex-col text-base  shadow-2xl text-zinc font-Satoshi font-thin   ">
          {" "}
          <span
        ...
        <div>
          <div className="  text-zinc-200 relative pr-10 text-xl flex items-end justify-center flex-col text-zinc font-Satoshi font-thin lg:visible invisible ">
            <span
            ...
            >
              <div className="mb-5 z-50">Le Chant des Oiseaux</div>
              <div
      ...
      >
        ...
        >
          ...
          >
            {" "}
            <img src="./lcdo1.webp" alt="LCDO" className=" rounded-md " />{" "}
          </div>
        </div>
        <div
          onClick={() => handlecarby()}
