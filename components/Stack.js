  ...
  return (
    <div className="relative z-10 h-auto flex flex-col justify-center items-center   ">
      <div className="2xl:px-16 sm:px-7 h-fit lg:w-1/2 flex items-center justify-center flex-col rounded-lg z-10  lg:mt-0 mt-10 relative ">
        ...
        >
          <span
            className={`text-xl flex items-start justify-center pt-5 w-48 h-48 border-1  rounded-xl border-opacity-50 group relative overflow-hidden ${
          ...
          <span
            className={`text-xl flex items-start justify-center pt-5 w-48 h-48 border-1 rounded-xl border-opacity-50 relative group overflow-hidden md:mt-0 mt-5 ${
              isDarkMode ? "border-zinc-200 " : "border-zinc-900 "
            } `}
          >
            {" "}
            ...
            />
            <div
              className={`w-2/3 h-2/3 bg-violet-400 bg-opacity-40 rounded-full absolute -bottom-32 z-10 group-hover:w-96 group-hover:h-96 transition-all duration-500 group-hover:bg-opacity-0 ${
                isDarkMode
